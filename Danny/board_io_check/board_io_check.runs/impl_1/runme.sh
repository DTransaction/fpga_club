...
HD_PWD='/home/danny/Documents/fpga_club/Danny/board_io_check/board_io_check.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_boardIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_boardIO.tcl -notrace
