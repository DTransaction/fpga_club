...
HD_PWD='/home/danny/Documents/fpga_club/Danny/board_io_check/board_io_check.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_boardIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_boardIO.tcl
